...
def main():
    ...
    parser.add_argument("--json_dir", default="/home/kls/PycharmProjects/Mask_RCNN/samples/train_data/json")
    ###############################################end###################################
    parser.add_argument("-o", "--out", default="/home/kls/PycharmProjects/Mask_RCNN/samples/train_data/labelme_json")
